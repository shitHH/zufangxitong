 ...
 * @author 李英
 * @date 2021-04-06
 * @category ownuser 的dao层接口 增加一个方法，根据角色ID查找对应的人
 */
public interface OwnUserDao {
     ...
     * @return 受影响的行数
     */
    public int addUser(OwnUser user);
     ...
     * @return 受影响的行数
     */
    public int update(OwnUser user);
     ...
     * @return 用户列表
     */
    public List<OwnUser> findOwnUserList(@Param("rid") int rid, @Param("aid") int aid);
     ...
     * @return 受影响的行数
     */
    public int addyezhu(OwnUser user);
}